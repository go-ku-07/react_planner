...
import deskIcon from './desk.png'
import deskUnavailableIcon from './ic-desk-unvailable.png'

const textureLoader = new Three.TextureLoader()
const whiteMaterial = new Three.MeshLambertMaterial({ color: 0x000000 })
const glassMaterial = new Three.MeshLambertMaterial({ color: 0xc6c6c6, transparent: true, opacity: 0.5 })
...
function makeObjectMinLOD(newWidthA, newWidthB, newHeight, newDepth) {
  ...
  let geometry4 = new Three.ExtrudeGeometry(glass, extrudeSettings)
  let glassMaterial = new Three.MeshLambertMaterial({ color: 0xc6c6c6, transparent: true, opacity: 0.5 })
  let mesh4 = new Three.Mesh(geometry4, glassMaterial)
  mesh4.position.y += newHeight
  mesh4.rotation.x += Math.PI / 2
...
export default {
  ...
  render2D: function render2D(element, layer, scene, isAvailable) {
    ...
    return (
      ...
      >
        {/* <path
          key="1"
          d={`M ${newWidthA / 2 - newWidthB / 2} 0 l ${-newWidthA / 2 + newWidthB / 2} ${newDepth} l ${newWidthA} 0 l ${
        ...
        <image
          ...
          href={isAvailable ? deskIcon: deskUnavailableIcon}
