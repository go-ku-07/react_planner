...
import ReactPlanerService, { Action, ItemTypes } from "../ReactPlannerService";
...
var Area = function () {
  ...
  _createClass(Area, null, [{
    ...
    value: function select(state, layerID, areaID) {
      ...
      // Autonomous
      ReactPlanerService.getInstance().onAction(Action.SELECT, ItemTypes.AREA, areaID);
    ...
    value: function remove(state, layerID, areaID) {
      ...
      // Autonomous
      ReactPlanerService.getInstance().onAction(Action.REMOVE, ItemTypes.AREA, areaID);
